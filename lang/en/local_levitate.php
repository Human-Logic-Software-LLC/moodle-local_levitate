...
$string['secret_url'] = 'Generate token';
$string['secret_help'] = 'The Token helps to authorize the user and explore Levitate courses ';
...
$string['outof'] = 'out of';
$string['xvalue'] = '×';
$string['report_month'] = 'Month';
$string['report_timespent'] = 'Timespent';
